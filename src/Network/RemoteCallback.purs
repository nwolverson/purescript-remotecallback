...
foreign import addExternalCallHandler :: forall eff. String -> (String -> Eff eff Unit) -> Eff eff Unit
...
jsonp :: forall eff. String -> String -> Aff (dom :: DOM | eff) String
...
-- | Register a raw self-unregistering external (global) call handler.
externalCall :: forall eff. String -> Aff (dom :: DOM | eff) String
